...
public class PharmacistFrame extends JFrame {
    ...
    private void buildUI() {
        ...
        JButton pending =
                new JButton("Pending Prescriptions");

        JButton preparing =
                new JButton("Start Preparing");

        JButton dispense =
                new JButton("Dispense");

        JButton collection =
                new JButton("Confirm Collection");
        ...
        pending.addActionListener(
                e -> showPending()
        );

        preparing.addActionListener(
                e -> startPreparing()
        );

        dispense.addActionListener(
                e -> dispense()
        );

        collection.addActionListener(
                e -> completeCollection()
        );
    ...
    private void showPending() {
        ...
        try (
                var conn =
                        pharmacy.database.DatabaseConnection
                                .getConnection();
                var ps =

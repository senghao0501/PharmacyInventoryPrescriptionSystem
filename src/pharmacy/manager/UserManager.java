...
public class UserManager {
    ...
    private User createUserFromResultSet(ResultSet rs)
        ...
        switch (role) {
            ...
            case PHARMACIST:
                ...
                pharmacist.setPharmacistLicenseId(
                        rs.getString("pharmacist_license_id")
                );

                pharmacist.setShiftSchedule(
            ...
            case ADMIN:
                ...
                admin.setAdminAccessLevel(
                        rs.getString("admin_access_level")
                );
    ...
    public List<User> searchPatients(String keyword) {
        ...
        String sql =
                ...
                + "WHERE role = 'PATIENT' "
                + "AND is_active = TRUE "
                + "AND (user_id LIKE ? OR full_name LIKE ?)";
